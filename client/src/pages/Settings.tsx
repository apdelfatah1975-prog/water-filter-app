...
export default function Settings() {
  ...
  function openWhatsAppPanel(panel: "manual" | "official") {
    setActiveWhatsAppPanel(current => current === panel ? null : panel);
    window.setTimeout(() => whatsappSectionRef.current?.scrollIntoView({ behavior: "smooth", block: "start" }), 0);
  }
